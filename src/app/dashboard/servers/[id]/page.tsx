...
type MetricPoint = { ts: string; activeUsers: number; pingMs: number; cpuPercent: number; ramPercent: number };
...
export default function ServerDetailPage() {
  ...
  return (
    <div className="space-y-6">
      <Link href="/dashboard" className="inline-flex items-center gap-1.5 text-sm text-slate-400 hover:text-cyan-300">
